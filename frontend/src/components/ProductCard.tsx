  ...
  return (
    ...
    >
      <Pressable
        ...
        onPress={() => {}}
      >
        <View className="h-36 bg-gray-100 dark:bg-zinc-9-- relative">
          <Image
          ...
          <Pressable
            onPress={() => {}}
            hitSlop={10}
            className="absolute right-2 top-2 px-2 py-1 rounded-full border border-gray-200 dark:border-zinc-700 bg-white"
          >
        ...
        <View className="border-t border-gray-200 items-center justify-center bg-violet-50 py-2">
          <Text
            numberOfLines={1}
            className="text-[12px] font-bold tracking-tight text-violet-700"
          >
            ⚡ GET IN 16 MIN
          </Text>
        </View>
